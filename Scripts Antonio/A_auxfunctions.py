...
def make_env(data,load_num,timestep,soc_max,eta,charge_lim,min_charge_step,reward_type):
    #prepare the data
    """
    ...
    env=flex.FlexEnv(data,soc_max,eta,charge_lim,min_charge_step, reward_type)
